...
if(main.classList.contains('page-produit')) {
  ...
  /* Il faut que dans l'URL du fetch, il y ait l'id du produit */
    ...
    .then(function(data) {
          ...
          nouveauProduit.innerHTML = '<img src="' + data.imageUrl +' " alt=""><div class="description-produit"><p>' + data.description + '</p><strong>' + (parseInt(data.price) / 1000).toFixed(2).toString().replace('.',',') + ' €' + '</strong></div>';
